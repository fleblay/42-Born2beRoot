...
DISK_USAGE=$(df -h | grep "root" | awk '{printf "%s", $3}')
DISK_TOTAL=$(df -h | grep "root" | awk '{printf "%s", $4}')
DISK_USED=$(df -h | grep "root" | awk '{printf "%s", $3}')
DISK_PERC=$(df -h | grep "root" | awk '{printf "%s", $5}')
